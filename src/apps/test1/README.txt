...
This test1.c file is a test to designed to demonstrate the functionality of the functions of osapi.c in the ../os/<OS>/ directory. The tests are separated into different modules- tasks, queues, binary semaphores, mutexes, and *GetInfo functions. 
